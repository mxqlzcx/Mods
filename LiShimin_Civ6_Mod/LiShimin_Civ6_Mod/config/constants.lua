...
return {
    ...
    UNIT_TIANCE_GENERAL         = UNIT_TIANCE_GENERAL,
    TIANCE_AURA_COMBAT_BONUS   = TIANCE_AURA_COMBAT_BONUS,
    TIANCE_AURA_RANGE          = TIANCE_AURA_RANGE,
    TIANCE_COMBAT              = TIANCE_COMBAT,
    TIANCE_RANGED_COMBAT       = TIANCE_RANGED_COMBAT,
    TIANCE_RANGE               = TIANCE_RANGE,
    TIANCE_MOVES               = TIANCE_MOVES,
    TIANCE_COST                = TIANCE_COST,
    UNIT_XUANJIA_ARMY          = UNIT_XUANJIA_ARMY,
    XUANJIA_ARMY_COMBAT        = XUANJIA_ARMY_COMBAT,
    XUANJIA_ARMY_MOVES         = XUANJIA_ARMY_MOVES,
    XUANJIA_ARMY_COST          = XUANJIA_ARMY_COST,
    BUILDING_XUANWU_GATE       = BUILDING_XUANWU_GATE,
    CORONATION_MIN_TURNS_AFTER_GATE = CORONATION_MIN_TURNS_AFTER_GATE,
    TALENT_RESERVE_PER_GP      = TALENT_RESERVE_PER_GP,
    TALENT_RESERVE_MAX_STACKS  = TALENT_RESERVE_MAX_STACKS,
    ...
    PRINCE_SCIENCE_PENALTY      = PRINCE_SCIENCE_PENALTY,
    PRINCE_CULTURE_PENALTY      = PRINCE_CULTURE_PENALTY,
    PRINCE_FOOD_PENALTY         = PRINCE_FOOD_PENALTY,
    PRINCE_MILITARY_PROD_BONUS  = PRINCE_MILITARY_PROD_BONUS,
    ZHENGUAN_PER_CITY_PCT       = ZHENGUAN_PER_CITY_PCT,
    ZHENGUAN_MAX_PCT            = ZHENGUAN_MAX_PCT,
    ENVOY_INTERVAL              = ENVOY_INTERVAL,
    JIEDUSHI_ENVOY_MULTIPLIER  = JIEDUSHI_ENVOY_MULTIPLIER,
    TIANZI_YANU_WINDOW          = TIANZI_YANU_WINDOW,
    YANWU_CAMP_BONUS_ENABLED    = YANWU_CAMP_BONUS_ENABLED,
    UNIT_LI_JIANCHENG           = UNIT_LI_JIANCHENG,
    LI_JIANCHENG_HP             = LI_JIANCHENG_HP,
    LI_JIANCHENG_MOVES          = LI_JIANCHENG_MOVES,
    LISHIMIN_NOTIFY_ICON_XUANWU_GATE  = LISHIMIN_NOTIFY_ICON_XUANWU_GATE,
    LISHIMIN_NOTIFY_ICON_CORONATION   = LISHIMIN_NOTIFY_ICON_CORONATION,
    COLORS                      = COLORS,
}
